(() => {
  // ../sprintspace/sprintspace/public/js/editor.bundle.js
  (function() {
    "use strict";
    ...
    class SprintSpaceKanbanTool {
      ...
      renderKanban(tasksByStatus, projectKey) {
        ...
        if (Object.keys(tasksByStatus).length === 0 || Object.values(tasksByStatus).every((tasks) => tasks.length === 0)) {
    ...
    async function initSprintSpaceEditor(frm) {
      if (frm.__sprintspace_editor_inited)
        return;
      frm.__sprintspace_editor_inited = true;
      if (!frm.fields_dict.content_json)
        return;
